(() => {
  ...
  // Status strings set deliberately; refreshStatus() leaves them in place
  // instead of replacing them with the context hint.
  ...
  function handleMainKeydown(e) {
    ...
    // required so the browser does not run native select-all / find.
